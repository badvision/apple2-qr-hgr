...
DEMO_PROGRAM_LINES = [
    ...
    "590 GET K$",
    "600 TEXT : HOME",
    "610 PRINT \"SELF-ENCODED: \";L;\" BYTES\"",
    "620 PRINT \"(BINARY DATA - NOT SCANNABLE)\"",
    "630 PRINT \"PRESS ANY KEY\": GET K$",
    "640 TEXT : HOME : PRINT \"DEMO COMPLETE.\"",
    "650 END",
    ...
    "9100 TEXT : HOME",
    "9110 PRINT A$",
    "9120 PRINT \"PRESS ANY KEY\": GET K$",
    "9130 RETURN",
]
